...
windowSurface = pygame.display.set_mode((width, hight))
...
drawText('PRESS ANY KEY TO START THE GAME!', font, windowSurface, (width / 3) -137, (hight / 3)+80)
...
while (count > 0):
    baddies = []
    score = 0
    playerRect.topleft = (width / 2, hight - 50)
    ...
    while True:
        ...
        if moveDown and playerRect.bottom < hight:
    ...
    if (count == 0):
        ...
        drawText('Game Over', font, windowSurface, (width/ 3)+40, (hight/ 3)+70)
        #drawText('Press any key to play again.', font, windowSurface, (width /3) - 110, (hight / 3) + 95)
        pygame.display.update()
        time.sleep(2)
        waitForPlayerToPressKey()
count = 10